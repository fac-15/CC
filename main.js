...
function validator(e) {
  ...
  // error messages:
  const nameMsg =
    "Please enter a valid name. You can enter letters a-z, upper and lower case";
  const companyMsg =
    "Please enter a valid company name. You can enter letters a-z, upper and lower case";
  const emailMsg = "Please enter a valid email address.";
  const phoneMsg =
    "Your phone number is too long. Please enter a valid UK phone number";
